...
export const Workshop = React.memo(function Workshop() {
  ...
  // Drawn at the size its box measures, not at 100%: Android sizes a
  // percentage SVG once, before the layout settles, and leaves it short.
  ...
  return (
    ...
    >
      {box ? (
        <Svg width={box.w} height={box.h} viewBox="0 0 400 260" preserveAspectRatio="xMidYMid slice">
          <Defs>
