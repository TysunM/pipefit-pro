...
const PAIRS: { fg: keyof Colors; bg: keyof Colors; min: number; what: string }[] = [
  ...
  // The featured tile is teal plate rather than slate, so it is checked on its own.
  { fg: 'text', bg: 'featureHi', min: 4.5, what: 'a featured tile title at the top of its plate' },
  { fg: 'text', bg: 'featureLo', min: 4.5, what: 'a featured tile title at the foot of its plate' },
  { fg: 'textMuted', bg: 'featureHi', min: 4.5, what: 'a featured tile subtitle at the top' },
  { fg: 'textMuted', bg: 'featureLo', min: 4.5, what: 'a featured tile subtitle at the foot' },
  { fg: 'feature', bg: 'featureHi', min: 4.5, what: 'the tag on a featured tile' },
  { fg: 'feature', bg: 'featureLo', min: 4.5, what: 'the tag at the foot of a featured tile' },
  { fg: 'text', bg: 'tabBar', min: 4.5, what: 'the selected tab' },
  { fg: 'textFaint', bg: 'tabBar', min: 4.5, what: 'a tab not selected' },
